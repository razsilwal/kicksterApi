...
from .models import Shoe, Order, Payment
from .serializers import ShoeSerializer, OrderSerializer
...
def verify_khalti_payment(request):
    ...
    response = request.post("https://khalti.com/api/v2/payment/verify/", data=payload, headers=headers)
